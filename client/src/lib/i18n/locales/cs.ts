...
export const cs = {
  ...
  validation: {
    ...
    appliance_name_required: 'Název spotřebiče je povinný.',
    power_not_negative: 'Zadejte nezáporné číslo.',
    priority_invalid: 'Priorita musí být 1 až 4.',
    hour_invalid: 'Zadejte hodinu 0 až 23.',
    minutes_invalid: 'Zadejte počet minut (alespoň 1).',
    minutes_range: 'Horní mez musí být alespoň tak velká jako dolní.',
    window_bounds_equal: 'Začátek a konec okna se musí lišit.',
    window_required: 'Přidejte alespoň jedno časové okno.',
    uses_invalid: 'Zadejte alespoň jedno spuštění.',
  ...
  appliances: {
    title: 'Spotřebiče',
    description: 'Z těchto spotřebičů se počítá predikce spotřeby lokality.',
    new: 'Nový spotřebič',
    empty: 'Pro tuto lokalitu zatím nejsou zadané žádné spotřebiče.',

    name: 'Název',
    name_placeholder: 'Lednice',
    power: 'Příkon',
    standby_power: 'Pohotovostní příkon',
    behavior: 'Chování',
    priority: 'Priorita',
    shiftable: 'Lze posunout v čase',
    cycle: 'Cyklus',
    cycle_value: 'běh {{activeMin}}–{{activeMax}} min, klid {{standbyMin}}–{{standbyMax}} min',
    active_min: 'Běh od (min)',
    active_max: 'Běh do (min)',
    standby_min: 'Klid od (min)',
    standby_max: 'Klid do (min)',
    max_uses: 'Max. spuštění za okno',

    windows: 'Časová okna',
    add_window: 'Přidat okno',
    remove_window: 'Odebrat okno',
    window_from: 'Od (h)',
    window_to: 'Do (h)',
    window_probability: 'Pravděpodobnost (%)',
    window_duration_min: 'Délka od (min)',
    window_duration_max: 'Délka do (min)',

    behavior_constant: 'Stálý odběr',
    behavior_cyclic: 'Cyklický',
    behavior_scheduled: 'Plánovaný',
    behavior_on_demand: 'Na vyžádání',
    behavior_hint_constant: 'Běží pořád se stejným příkonem — třeba router nebo oběhové čerpadlo.',
    behavior_hint_cyclic: 'Střídá běh a klid — typicky lednice nebo mraznička.',
    behavior_hint_scheduled: 'Běží v daných časových oknech — třeba bojler nebo nabíjení auta.',
    behavior_hint_on_demand: 'Spouští ho člověk v rámci okna — myčka, pračka, trouba.',

    hint_power: 'Ve wattech = {{kw}} kW. Pozor, jinde v aplikaci jsou kilowatty.',
    hint_power_empty: 'Ve wattech. Pozor, jinde v aplikaci jsou kilowatty.',
    hint_windows:
      'Predikce rozprostře očekávanou dobu běhu přes celé okno, takže v grafu uvidíte plochý odběr, ne špičku. Okno přes půlnoc zapište jako 22 → 6; „do půlnoci“ je 0.',
    hint_future_use: 'Zatím neovlivňuje predikci, počítá s tím až optimalizace.',

    create_title: 'Nový spotřebič',
    edit_title: 'Úprava spotřebiče',
    form_description: 'Hodnoty najdete na štítku spotřebiče nebo v jeho návodu.',

    edit: 'Upravit',
    delete: 'Smazat',
    delete_title: 'Smazat spotřebič {{name}}?',
    delete_description: 'Predikce spotřeby se přepočítá bez něj. Akci nelze vrátit.',
    deleted: 'Spotřebič {{name}} byl smazán.',
    created: 'Spotřebič {{name}} byl vytvořen.',
    updated: 'Spotřebič {{name}} byl upraven.',
    submit: 'Uložit',
    submitting: 'Ukládám…',
    cancel: 'Zrušit',
  },
